...
public class InvalidContextVariableException extends TemplateProcessorException {
    public InvalidContextVariableException(String keyword, Object value, String context) {
        super(String.format("The context variable \"%s\" with value \"%s\" is not valid. %s", keyword, value, context), null);
    }
